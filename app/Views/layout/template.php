  ...
  <body class="text-slate-800 overflow-hidden">
    <nav class="flex justify-between items-center px-7 py-3 shadow-lg">
        <div>
            ...
            <div class="w-full h-full bg-slate-800/50 absolute top-0 right-0 transition-opacity transition-display opacity-0 hidden" id="sidebar-overlay"></div>
            <div class="flex flex-col gap-[.15rem] top-0 left-0 bg-slate-100 h-screen w-full lg:w-3/12 z-50 transition-tran`sform transform -translate-x-full fixed inset-0" id="sidebar-wrapper">
