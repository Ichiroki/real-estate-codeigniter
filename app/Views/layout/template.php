...
<html>
  ...
  <body class="text-slate-800 overflow-hidden">
    <nav class="flex flex-row-reverse lg:flex-row justify-between items-center px-7 py-3 shadow-lg fixed top-0 left-0 right-0 z-10 bg-slate-200">
        ...
        <div class="w-full h-full bg-slate-800/50 fixed top-0 right-0 transition-opacity transition-display opacity-0 hidden" id="sidebar-overlay"></div>
        <div class="flex flex-col gap-[.15rem] top-0 left-0 bg-slate-100 h-screen w-full lg:w-3/12 z-20 transition-transform transform -translate-x-full fixed inset-0" id="sidebar-wrapper">
            <div class="flex justify-between px-5 py-8">
                <h1>Main Menu</h1>
                <p class="cursor-pointer" id="sidebar-close-button">X</p>
            </div>
            <div class="flex justify-between transition hover:bg-slate-300 py-2 pl-5">
            ...
            <div class="flex flex-col justify-between transition py-2 pl-5">
                <button class="flex items-center w-full" id="listing-dropdown">
                ...
                <div id="listing-list" class="hidden flex-col gap-3 bg-slate-400 lg:w-11/12 border-2 border-slate-500 shadow mt-3 rounded-xl overflow-hidden transition-all">
                    <a href="#" class="flex gap-5 pl-11 py-2 transition hover:bg-slate-500 hover:text-slate-100">
            ...
            <div class="flex justify-between transition hover:bg-slate-300 py-2 pl-5">
                <a href="" class="flex items-center">
                    ...
                    <p class="ml-5">About Us</p>
                </a>
            </div>
            <div class="flex justify-between transition hover:bg-slate-300 py-2 pl-5">
                <a href="" class="flex items-center">
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" class="bi bi-bookshelf" viewBox="0 0 16 16">
        ...
        <div class="flex flex-col transition py-2 pl-5 w-1/3">
            ...
            <div id="login-list" class="hidden absolute top-12 right-12 flex-col bg-slate-100 lg:w-1/12 border-2 border-slate-500 shadow mt-3 rounded-xl overflow-hidden transition-all">
                <a href="<?= url_to('userLoginPage') ?>" class="flex gap-5 pl-3 py-2 transition hover:bg-slate-300">
                    <span>User</span>
                </a>
    ...
    <script src="<?= base_url('/js/hamburger.js') ?>"></script>
